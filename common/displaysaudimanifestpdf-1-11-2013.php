...
$header ='';
	...
	$header .='	<table  width="100%" align="center">
    	<tr>
        	<td align="center" colspan="2"><b>NATIONAL HAJJ COMISSION OF NIGERIA(NAHCON)</b></td>
         </tr>
    	<tr>
        	<td align="center" colspan="2"><b>ROYALITY PAYMENT SLIP</b></td>
         </tr>
		<tr>
			<td><b>Flight ID:</b> '.getflightno($flight_id).'</td>
			<td><b>Carrier Name: </b>'.getcarriername($carrier_id).'</td>
		</tr>
		<tr>
			<td colspan="8">&nbsp;</td>
		</tr>
