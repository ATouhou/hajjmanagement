...
$html2pdf = new HTML2PDF('L','A4','en',false, 'ISO-8859-15', array(8,8, 8, 10)); 
	...
	$header .='<tr>
	  				<td colspan="3"  align="center">LUGGAGE DETAILS FOR&nbsp;</td>
			  </tr>';
	$header .='<tr>
	  				<td colspan="3"  align="center">Flight No:'.$flight_carrier_data['flight_no'].' Date:'.$flight_carrier_data['date1'].' Time:'.$flight_carrier_data['time1'].'          FROM '.getflightlocationname($flight_carrier_data['source']).' TO:'.getflightlocationname($flight_carrier_data['destination']).'&nbsp;</td>
			  </tr>';
	$header .='<tr>
					<td>*T = total Kg </td>
					<td>*E = Extra Kg </td>
