...
$run = $db->query("SELECT * FROM eticket LEFT JOIN pilgrims USING (pilgrim_id) LEFT JOIN agency_seat_allocation using (allocation_id)  WHERE pilgrims.passport_no='".$passportno."' AND agency_seat_allocation.agency_id='".$_SESSION['agency_id']."'");
...
<?php } ?>    
    ...
    <td> <a href="<?php echo $_SESSION['basemodule'].'reschedule.php?id='.base64_encode($data[$i]['id']); ?>"><img src="../images/schedule.png" /></a></td>
  </tr>
<?php } ?>  
</table>
<?php }else{ ?>
