...
-->     </tr>
        ...
        <tr>
		  ...
		  <td><div align="center"><a href="<?php echo $_SESSION['basemodule']; ?>addaccomodation.php?id=<?php echo base64_encode($key['id']);  ?>" title="Edit" class="icon-1 info-tooltip"></a></td> 
       </tr>
		<?php
		}
		?>
