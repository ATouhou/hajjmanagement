...
<?php } ?>    
    ...
    <td> <a href="<?php echo $_SESSION['basemodule'].'eticket.php?id='.base64_encode($data[0]['eno']); ?>">View</a>&nbsp;<?php if($_SESSION['access_right']!=3){ ?> <a href="#"class="icon-2 info-tooltip" title="Delete" onclick="eticketdelete(<?php  echo $boarding_data[$i]['bno']; ?>); return false;"></a> <?php } ?> </td>
  </tr>
<?php } ?>  
</table>
