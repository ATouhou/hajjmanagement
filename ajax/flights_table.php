...
?>
      ...
      <!--    <th class="table-header-repeat line-left" ><a href="#">Arrival</a></th> -->
       ...
       <!--   <td><?php echo $key['date2'].' '.$key['time2'];  ?></td> -->
		  ...
		  <td><div align="center" style="display:block">
          
          <?php if($_SESSION['access_right']!=3){ ?><a href="#" style="float:left;" onclick="deleteRow('<?php echo $key['flight_id']; ?>'); return false;" title="Delete" class="icon-2 info-tooltip"></a><?php } ?>        
          <a href="<?php echo $_SESSION['basemodule']; ?>addflights.php?flightid=<?php echo $key['flight_id']; ?>" title="Edit" class="icon-1 info-tooltip"></a></div>
<div id="status_<?php echo $key['flight_id']; ?>">        
<a href="#" title="Status" style="float:left;" onclick="changeflightstatus('status',<?php echo $key['flight_id']; ?>,'<?php echo $key['status']; ?>');" class="<?php if($key['status']=='Active'){ echo "icon-5 info-tooltip"; }else echo "icon-3 info-tooltip"; ?>"></a></div>
		  </td>
       </tr>
		<?php
		}
