...
$run_disp = $db->query("SELECT SQL_CALC_FOUND_ROWS * FROM agency_seat_allocation asa, boardingpass bp, flights f WHERE asa.flight_id='".$id."' AND f.flight_id='".$id."' AND asa.allocation_id=bp.allocation_id ORDER BY f.createdon DESC LIMIT $start, $nor");
...
?>
	  <table id="product-table" width="850">
        ...
        <tr>
          ...
          <th class="table-header-repeat line-left" ><a href="#">Ticket No </a> </th>
       </tr>
        </thead>
		<tbody>
