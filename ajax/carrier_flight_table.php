...
-->     </tr>
	...
	//		$row_info = $db->fetch($run_info);
        ...
        <tr>
          ...
          <td><div align="center"><?php if($_SESSION['access_right']!=3){ ?><a href="<?php echo $_SESSION['basemodule']; ?>editmanifest.php?id=<?php echo base64_encode($key['flight_id']);  ?>" title="Edit" class="icon-1 info-tooltip"></a><?php }else{ echo 'NA';} ?></div></td>
       </tr>
		<?php
		}
		?>
