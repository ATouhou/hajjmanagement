...
$run_disp = $db->query("SELECT SQL_CALC_FOUND_ROWS * FROM agency_seat_allocation WHERE agency_id='".$_SESSION['agency_id']."' ORDER BY createdon DESC LIMIT $start, $nor");
$num_disp = $db->total();
...
<!--          <td><?php echo $row_info['date1'].' '.$row_info['time1'];  ?></td>
          <td><?php echo $row_info['date2'].' '.$row_info['time2'];  ?></td>
