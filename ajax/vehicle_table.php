...
-->     </tr>
		...
		?>
        <tr>
          <td><a href="#"><?php echo $key['vehicle_no']; ?></a></td>
		  ...
		  <td><div align="center"><a href="<?php echo $_SESSION['basemodule']; ?>addvehicle.php?id=<?php echo base64_encode($key['vehicle_id']);  ?>" title="Edit" class="icon-1 info-tooltip"></a></td> 
       </tr>
		<?php
		}
		?>
