...
?>
	  <table id="product-table" width="850">
        ...
        <tr>
          ...
          <th class="table-header-repeat line-left" ><a href="#">Remaining Seats</a></th>
        ...
        <tr>
          ...
          <td><?php echo getremaningseats($key['flight_id']);  ?></td>
...
<a href="<?php echo $_SESSION['basemodule']; ?>seatallocation.php?flight_id=<?php echo $key['flight_id']; ?>">Select</a></div>
