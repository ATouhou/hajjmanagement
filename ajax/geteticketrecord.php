...
<?php } ?>    
    ...
    <td><?php if($_SESSION['access_right']!=3){ ?> <a href="#"class="icon-2 info-tooltip" title="Delete" onclick="eticketdelete(<?php  echo $data[0]['eno']; ?>,<?php echo $data[$i]['id']; ?>); return false;"></a> <?php } ?>  <a href="<?php echo $_SESSION['basemodule'].'reschedule.php?id='.base64_encode($data[$i]['id']); ?>"><img src="../images/schedule.png" /></a> &nbsp;<a href="<?php echo $_SESSION['basemodule'].'eticket.php?id='.base64_encode($data[$i]['eno']); ?>">View</a></td>
  </tr>
<?php } ?>  
</table>
<?php }else{ ?>
