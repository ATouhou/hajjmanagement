...
-->     </tr>
		...
		?>
        <tr id="<?php echo $key['manifest_id']; ?>" >
          ...
          <td><?php if($_SESSION['access_right']!=3){ ?><a href="#" style="float:left;" onclick="deleteRow('<?php echo $key['manifest_id']; ?>'); return false;" title="Delete" class="icon-2 info-tooltip"></a><?php } ?>        
		  </td>
       </tr>
		<?php
		}
