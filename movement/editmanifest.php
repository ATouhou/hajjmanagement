...
if (window.XMLHttpRequest)
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	xmlhttp.open("GET","../ajax/movement_edit_manifest_table.php?val="+val+"&id="+id,true);
xmlhttp.send();
}
...
function deleteRow(manifestId) {
			...
			if(res==true){
				...
				xmlhttp.open("GET","../ajax/deletepassengermovementmanifest.php?manifestId="+manifestId,true);
				xmlhttp.send();		
			}
}
...
<div id="create_pilgrim_table">        
		<?php include('../ajax/movement_edit_manifest_table.php'); ?>
</div>        
