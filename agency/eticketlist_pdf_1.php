...
/*
	...
	$content .='<tr>
					<td colspan="2"><strong><span style="color:#009966">CARRIER NAME</span>&nbsp;&nbsp;&nbsp;&nbsp;</strong>'.$fdata1['carriers_name'].'</td>
					<td>&nbsp;</td>
	...
	$content .='	</td>
					<td><strong><span style="color:#009966">PHONE NO.</span>&nbsp;&nbsp;&nbsp;&nbsp;</strong>+234 - '.$fdata1['carriers_phoneno'].'</td>
					<td>&nbsp;</td>
				</tr>';	
	$content .='<tr>   
	...
	$content .='<tr>
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td><strong>Passenger Status:</strong>'.$pdata[ 'pilgrim_status' ].'</td>   
					<td>&nbsp;</td>
				</tr>';
    $title='';
    if ( $pdata[ 'sex' ] == "Male" ) {
	...
	$content .='<tr>
				...
				<tr>
					<td colspan="4">'.$fdata1[ 'terms_conditions' ].'
					</td>
				  <td>&nbsp;</td>
				</tr>
				<tr>
