...
if (window.XMLHttpRequest)
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	xmlhttp.open("GET","../ajax/report_agency_flight_table.php?val="+val,true);
xmlhttp.send();
}
 </script>
<!-- start content-outer -->
...
<div id="page-heading"><h1>Eticket/ Boarding Pass Reports</h1></div>
...
<div id="create_pilgrim_table">     
		<?php include('../ajax/report_agency_flight_table.php'); ?>
</div>        
