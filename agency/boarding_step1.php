                                ...
                                <td>
                                    <form action="../action/boardingpass_transact.php" method="post" onsubmit="return checkfrm(this);">
                                        ...
                                        <table width="850" id="boarding-table">
                                            ...
                                            <tr>
                                                <th colspan="2">Flight Information ( <?php echo $flight1_data[ 0 ][ 'flight_no' ]; ?> )<input type="hidden" name="eitcketrow1_id" value="<?php echo $eticketrow1_id; ?>"  /></th>
                                                <td width="250">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
...
<?php if ( $rec == 2 ) { ?>
                                                <tr>
                                                    <th colspan="2"><input type="hidden" name="allocation_id2" id="allocation_id2" value="<?php echo $allocation_id2; ?>" />Flight Information ( <?php echo $flight2_data[ 0 ][ 'flight_no' ]; ?> )<input type="hidden" name="eitcketrow2_id" value="<?php echo $eticketrow2_id; ?>"  /></th>
                                                    <td width="250">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3">
