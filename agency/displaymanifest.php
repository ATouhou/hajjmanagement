...
if (window.XMLHttpRequest)
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	xmlhttp.open("GET","../ajax/agency_manifest_table.php?val="+val+"&id="+id,true);
xmlhttp.send();
}
...
<tr>
	...
	<td>
        <?php notification(); ?>
        <h3><a href="../common/generatepilgrimmanifestpdf.php?id=<?php echo base64_encode($id); ?>" target="_blank"><img src="../images/pdf.png" width="32" /></a></h3>
<div id="create_pilgrim_table">        
		<?php include('../ajax/agency_manifest_table.php'); ?>
</div>        
	</td>
	<td>
