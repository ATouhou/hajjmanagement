...
if (window.XMLHttpRequest)
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	xmlhttp.open("GET","../ajax/editagency_manifest_table.php?val="+val+"&id="+id,true);
xmlhttp.send();
}
...
<div id="page-heading"><h1>Edit Manifest</h1></div>
...
<tr>
	...
	<div id="content-table-inner">
	        <h3>*Note-<font color="#FF0000">Luggage attached to this e-ticket will be deleted automatically</font></h3>
	...
	<td>
      ...
      <div id="create_pilgrim_table">         
 		<?php include('../ajax/editagency_manifest_table.php'); ?>
</div>        
	</td>
	<td>
