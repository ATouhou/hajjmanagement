...
include('../menu/menu_agency_users.php');
?>
 <script type="text/javascript">
 function pagination(val,id)
{
	var xmlhttp;
if (window.XMLHttpRequest)
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	xmlhttp.open("GET","../ajax/eticket_report_table.php?val="+val+"&id="+id,true);
xmlhttp.send();
}
...
<div id="page-heading"><h1>User Report Of Employee </h1></div>
...
<div id="create_pilgrim_table">        
		<?php include('../ajax/eticket_report_table.php'); ?>
</div>        
	</td>
	<td>
