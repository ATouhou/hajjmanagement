...
$db->query("INSERT INTO `boardingpass` (`bno` ,`eno` ,`pilgrim_id` ,`seat_no` ,`createdon` ,`allocation_id` ,`createdby` ,`status`)VALUES ('".$bno."', '".$_POST['eno']."', '".$_POST['pilgrim_id']."', '".$_POST['seats1']."',CURRENT_TIMESTAMP , '".$_POST['allocation_id1']."', '".$_SESSION['uid']."', 'Active')");
...
if($_POST['path']==2)
{
	$db->query("INSERT INTO `boardingpass` (`bno` ,`eno` ,`pilgrim_id` ,`seat_no` ,`createdon` ,`allocation_id` ,`createdby` ,`status`)VALUES ('".$bno."', '".$_POST['eno']."', '".$_POST['pilgrim_id']."', '".$_POST['seats2']."',CURRENT_TIMESTAMP , '".$_POST['allocation_id2']."', '".$_SESSION['uid']."', 'Active')");	
