...
<div id="print_area">
		...
		{
			$data[] = $row_flightdate;
			$date_man = split('-',$row_flightdate['flight_date']);
			$date_month = $month_num[$date_man[1]];
			$date_year = '20'.$date_man[2];
			$flightdatedetails[] = $date_year.'-'.$date_month.'-'.$date_man[0];
			$flightnodetails[] = $row_flightdate['flight_no'];
...
<tr>
    ...
    <td><font color="#FF0000">Dummy E-Ticket</font></td>
...
<tr>
    <td style="background-color:#333;"><font color="#FFF"><strong>DEPARTURE DATE:&nbsp;&nbsp;&nbsp;</strong><?php  echo $data[0]['flight_date']; ?></font></td>
...
?>
<tr>
	<td style="background-color:#333;"><font color="#FFF"><strong>DEPARTURE DATE:&nbsp;&nbsp;&nbsp;</strong><?php   echo $data[1]['flight_date']; ?></font></td>
