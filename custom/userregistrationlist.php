...
$run_user = $db->query("SELECT * FROM users WHERE uid ='".$id."'");
$row_user = $db->fetch($run_user);
...
if (window.XMLHttpRequest)
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	xmlhttp.open("GET","../ajax/custom_userregistration_table.php?val="+val+"&id="+id,true);
xmlhttp.send();
}
...
<div id="page-heading"><h1>User Wise Report </h1></div>
...
<div id="create_pilgrim_table">        
		<?php  include('../ajax/custom_userregistration_table.php'); ?>
</div>        
