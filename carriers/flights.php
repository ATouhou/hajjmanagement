...
function deleteRow(flightId) {
			var res = window.confirm('All Eticket from both the flights will be deleted'); 
			if(res==true){
				...
				xmlhttp.open("GET","../ajax/deleteeticketrecordbyflightid.php?flightid="+flightId,true);
				xmlhttp.send();		
			}
}
...
<div id="page-heading"><h1>Flight Management</h1></div>
...
<?php include('../ajax/flights_table.php'); ?>        
</div>
		<!-- end id-form  -->
