...
$run = $db->query("SELECT full_name,bno,passport_no, seat_no, flight_id  FROM boardingpass LEFT JOIN pilgrims USING(pilgrim_id) LEFT JOIN agency_seat_allocation USING(allocation_id) WHERE bno='".base64_decode($_REQUEST['id1'])."'");
...
$run = $db->query("SELECT full_name,bno,passport_no, flight_id, seat_no  FROM boardingpass LEFT JOIN pilgrims USING(pilgrim_id) LEFT JOIN agency_seat_allocation USING(allocation_id) WHERE bno='".base64_decode($_REQUEST['id2'])."'");
