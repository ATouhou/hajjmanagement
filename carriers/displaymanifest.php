...
if (window.XMLHttpRequest)
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	xmlhttp.open("GET","../ajax/carrier_manifest_table.php?val="+val+"&id="+id+"&agency_id="+agency_id,true);
xmlhttp.send();
}
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
 	...
 	document.getElementById('create_pilgrim_table').innerHTML ='<div align="left"><center><img src="../images/loading.gif" width="40" /></center></div>';  
	xmlhttp.open("GET","../ajax/carrier_manifest_table.php?val="+val+"&id="+id+"&agency_id="+agency_id,true);
	xmlhttp.send();
}
