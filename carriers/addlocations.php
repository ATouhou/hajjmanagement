...
<a href="<?php echo $_SESSION['basemodule'].'locations.php'; ?>"><h3>Back</h3></a>	
		<!-- start id-form -->
<form  name="regisfrm"  method="post" action="../action/location_carriers_transact.php?action=<?php if(isset($_REQUEST['location_id'])){ echo "edit";}else { echo "add"; }?>" id="regisfrm" >
