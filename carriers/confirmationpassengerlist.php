...
<h3><a href="../common/generatepassengerlist.php?id=<?php echo $_REQUEST['id']; ?>" target="_blank"><img src="../images/pdf.png" width="32" />Download list</a></h3>
...
<div id="create_pilgrim_table">        
		<?php  include('../ajax/carrier_boarding_confirmation_table.php'); ?>
</div>        
	</td>
	<td>
