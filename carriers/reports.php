...
if (window.XMLHttpRequest)
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	xmlhttp.open("GET","../ajax/agency_carrier_flight_table.php?val="+val,true);
xmlhttp.send();
}
...
<div id="page-heading"><h1>Reports</h1></div>
...
<div id="create_pilgrim_table">        
		<?php include('../ajax/agency_carrier_flight_table.php'); ?>
</div>        
