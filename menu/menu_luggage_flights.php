...
<?php if(($_SESSION['cid']==2)|| ($_SESSION['cid']==5)){ ?>
		...
		<ul class="current"><li><a href="<?php echo $_SESSION['basemodule'].'luggage.php'; ?>"><b>Luggage</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li><a href="<?php echo $_SESSION['basemodule'].'newluggage.php'; ?>">New</a></li>
