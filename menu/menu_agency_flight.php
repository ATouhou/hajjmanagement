...
<div class="nav-outer"> 
		...
		<ul class="current"><li><a href="<?php echo $_SESSION['basemodule'].'carriers.php'; ?>"><b>Carrier</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		...
		<ul class="select"><li><a href="<?php echo $_SESSION['basemodule'].'book.php'; ?>"><b>Book Eticket</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li><a href="#">&nbsp;</a></li>
