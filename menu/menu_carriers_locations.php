...
<div class="nav-outer"> 
		...
		<ul class="select"><li><a href="<?php echo CARRIERS.'aircraft.php';?>"><b>Aircraft</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
		...
		<ul class="current"><li><a href="<?php echo CARRIERS.'locations.php'; ?>"><b>Locations</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
