...
<?php if(($_SESSION['cid']==2)|| ($_SESSION['cid']==6)){ ?>
		...
		<ul class="current"><li><a href="<?php echo $_SESSION['basemodule'].'bconfirmation.php'; ?>"><b>Confirm</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li><a href="<?php echo $_SESSION['basemodule'].'confirmationlist.php'; ?>">Confirmation List</a></li>
				<li><a href="<?php echo $_SESSION['basemodule'].'agencyconfirmationlist.php'; ?>">Agency List</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
